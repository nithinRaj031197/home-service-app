    ...
    <View style={{ alignItems: "center" }}>
      ...
      <View style={styles.subContainer}>
        ...
        <Text style={{ fontSize: 12, color: Colors.WHITE, textAlign: "center", marginTop: 20 }}>
          Best App to find services near you which deliever you a professional service
        </Text>

        <TouchableOpacity style={styles.button} onPress={onPress}>
          <Text style={{ textAlign: "center", fontSize: 12, color: Colors.PRIMARY }}> Let's Get Started</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
